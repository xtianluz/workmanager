...
class WorkManagerBluromaticRepository(context: Context) : BluromaticRepository {
    ...
    //override val outputWorkInfo: Flow<WorkInfo?> = MutableStateFlow(null) //old code
    ...
    override fun applyBlur(blurLevel: Int) {
        ...
        //var continuation = workManager.beginWith(OneTimeWorkRequest.from(CleanupWorker::class.java)) //old code
        ...
        //previous code - for single worker
        //workManager.enqueue(blurBuilder.build())
